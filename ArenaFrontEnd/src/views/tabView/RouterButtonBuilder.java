...
public class RouterButtonBuilder {
    ...
    public RouterButtonBuilder controllerFactory(javafx.util.Callback<java.lang.Class<?>, java.lang.Object> controllerFactory){
        controller.setControllerFactory(controllerFactory);
        return this;
    }

    public RouterButtonBuilder currentControllerProperty(ObjectProperty<FXMLViewController> currentController){
